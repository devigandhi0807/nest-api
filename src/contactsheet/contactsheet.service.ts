...
import { CONTACTSHEET_REPOSITORY } from 'src/db/db-provide.constant';
...
export class ContactsheetService {
  constructor(
    ...
    @InjectRepository(ContactSheet) private readonly contactRepository: Repository<ContactSheet>
    ){}
